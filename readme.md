# useAsync() [![use-async](https://img.shields.io/npm/v/use-async?label=use-async&color=greenlime)](https://www.npmjs.com/package/use-async) [![tests](https://github.com/franciscop/use-async/workflows/tests/badge.svg)](https://github.com/franciscop/use-async/actions) [![gzip size](https://img.badgesize.io/franciscop/use-async/master/index.min.js.svg?label=gzip&logo=&compression=gzip)](https://github.com/franciscop/use-async/blob/master/index.min.js) [![dependencies](https://img.shields.io/badge/dependencies-0-limegreen.svg)](https://github.com/franciscop/use-async/blob/master/package.json)
